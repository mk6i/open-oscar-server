...
// Keep this column list aligned with SetBasicInfo, SetMoreInfo, SetWorkInfo,
// SetPermissions, SetUserNotes, SetInterests, SetAffiliations, and SetHomepageCategory.
