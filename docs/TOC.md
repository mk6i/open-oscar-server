...
This document is the authoritative reference for the TOC (Talk to OSCAR
...
All TOC communication is wrapped in FLAP (SFLAP) frames over a single TCP
...
| screen_name | Normalized screen name |
