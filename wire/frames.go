...
// response (bit 0). ICQ search replies keep this flag set on every hit,
// including the last; the client uses the meta subtype (0x01A4 vs 0x01AE) to
// detect the final result.
