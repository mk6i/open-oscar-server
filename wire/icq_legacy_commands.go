...
const (
	...
	ICQLegacyCmdGetDeps        uint16 = 0x03F2 // Get departments
	...
	ICQLegacyCmdThruServer2    uint16 = 0x0456 // Send message (alternate)
	...
	ICQLegacyCmdSetBasicInfo   uint16 = 0x050A // Update basic profile
	...
	ICQLegacyCmdGetDeps1       uint16 = 0x05F0 // Get departments (alternate)
...
const (
	...
	ICQLegacySrvUserDepsList   uint16 = 0x0032 // Departments list (login)
	ICQLegacySrvUserDepsList1  uint16 = 0x0082 // Departments list (session) - from v3_send_depslist1()
