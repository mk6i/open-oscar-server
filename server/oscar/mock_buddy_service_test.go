...
func (_mock *mockBuddyService) AddBuddies(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x04_BuddyAddBuddies) error {
...
func (_c *mockBuddyService_AddBuddies_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x04_BuddyAddBuddies)) *mockBuddyService_AddBuddies_Call {
...
func (_c *mockBuddyService_AddBuddies_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x04_BuddyAddBuddies) error) *mockBuddyService_AddBuddies_Call {
	_c.Call.Return(run)
	return _c
}

// AddTempBuddies provides a mock function for the type mockBuddyService
func (_mock *mockBuddyService) AddTempBuddies(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x0F_BuddyAddTempBuddies) error {
	ret := _mock.Called(ctx, sess, snac)
...
func (_c *mockBuddyService_AddTempBuddies_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x0F_BuddyAddTempBuddies)) *mockBuddyService_AddTempBuddies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockBuddyService_AddTempBuddies_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x0F_BuddyAddTempBuddies) error) *mockBuddyService_AddTempBuddies_Call {
	_c.Call.Return(run)
	return _c
}

// DelBuddies provides a mock function for the type mockBuddyService
func (_mock *mockBuddyService) DelBuddies(context1 context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x05_BuddyDelBuddies) error {
	ret := _mock.Called(context1, sess, inBody)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, *state.SessionInstance, wire.SNAC_0x03_0x05_BuddyDelBuddies) error); ok {
		r0 = returnFunc(context1, sess, inBody)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *mockBuddyService_Expecter) DelBuddies(context1 interface{}, sess interface{}, inBody interface{}) *mockBuddyService_DelBuddies_Call {
	return &mockBuddyService_DelBuddies_Call{Call: _e.mock.On("DelBuddies", context1, sess, inBody)}
}

func (_c *mockBuddyService_DelBuddies_Call) Run(run func(context1 context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x05_BuddyDelBuddies)) *mockBuddyService_DelBuddies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockBuddyService_DelBuddies_Call) RunAndReturn(run func(context1 context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x03_0x05_BuddyDelBuddies) error) *mockBuddyService_DelBuddies_Call {
	_c.Call.Return(run)
	return _c
}

// DelTempBuddies provides a mock function for the type mockBuddyService
func (_mock *mockBuddyService) DelTempBuddies(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x10_BuddyDelTempBuddies) error {
	ret := _mock.Called(ctx, sess, snac)
...
func (_c *mockBuddyService_DelTempBuddies_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x10_BuddyDelTempBuddies)) *mockBuddyService_DelTempBuddies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockBuddyService_DelTempBuddies_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, snac wire.SNAC_0x03_0x10_BuddyDelTempBuddies) error) *mockBuddyService_DelTempBuddies_Call {
	_c.Call.Return(run)
	return _c
}
