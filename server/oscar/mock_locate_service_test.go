...
// RightsQuery provides a mock function for the type mockLocateService
func (_mock *mockLocateService) RightsQuery(ctx context.Context, inFrame wire.SNACFrame) wire.SNACMessage {
...
func (_c *mockLocateService_RightsQuery_Call) Return(sNACMessage wire.SNACMessage) *mockLocateService_RightsQuery_Call {
	_c.Call.Return(sNACMessage)
	return _c
}

func (_c *mockLocateService_RightsQuery_Call) RunAndReturn(run func(ctx context.Context, inFrame wire.SNACFrame) wire.SNACMessage) *mockLocateService_RightsQuery_Call {
	_c.Call.Return(run)
	return _c
}

// SetDirInfo provides a mock function for the type mockLocateService
func (_mock *mockLocateService) SetDirInfo(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x09_LocateSetDirInfo) (wire.SNACMessage, error) {
...
func (_c *mockLocateService_SetDirInfo_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x09_LocateSetDirInfo)) *mockLocateService_SetDirInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockLocateService_SetDirInfo_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x09_LocateSetDirInfo) (wire.SNACMessage, error)) *mockLocateService_SetDirInfo_Call {
	_c.Call.Return(run)
	return _c
}

// SetInfo provides a mock function for the type mockLocateService
func (_mock *mockLocateService) SetInfo(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x02_0x04_LocateSetInfo) error {
...
func (_c *mockLocateService_SetInfo_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x02_0x04_LocateSetInfo)) *mockLocateService_SetInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockLocateService_SetInfo_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, inBody wire.SNAC_0x02_0x04_LocateSetInfo) error) *mockLocateService_SetInfo_Call {
	_c.Call.Return(run)
	return _c
}

// SetKeywordInfo provides a mock function for the type mockLocateService
func (_mock *mockLocateService) SetKeywordInfo(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, body wire.SNAC_0x02_0x0F_LocateSetKeywordInfo) (wire.SNACMessage, error) {
...
func (_c *mockLocateService_SetKeywordInfo_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, body wire.SNAC_0x02_0x0F_LocateSetKeywordInfo)) *mockLocateService_SetKeywordInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg3 wire.SNAC_0x02_0x0F_LocateSetKeywordInfo
		if args[3] != nil {
			arg3 = args[3].(wire.SNAC_0x02_0x0F_LocateSetKeywordInfo)
		}
		run(
			arg0,
			arg1,
...
func (_c *mockLocateService_SetKeywordInfo_Call) Return(sNACMessage wire.SNACMessage, err error) *mockLocateService_SetKeywordInfo_Call {
	_c.Call.Return(sNACMessage, err)
	return _c
}

func (_c *mockLocateService_SetKeywordInfo_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, body wire.SNAC_0x02_0x0F_LocateSetKeywordInfo) (wire.SNACMessage, error)) *mockLocateService_SetKeywordInfo_Call {
	_c.Call.Return(run)
	return _c
}

// UserInfoQuery provides a mock function for the type mockLocateService
func (_mock *mockLocateService) UserInfoQuery(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x05_LocateUserInfoQuery) (wire.SNACMessage, error) {
	ret := _mock.Called(ctx, sess, inFrame, inBody)
...
func (_c *mockLocateService_UserInfoQuery_Call) Run(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x05_LocateUserInfoQuery)) *mockLocateService_UserInfoQuery_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockLocateService_UserInfoQuery_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance, inFrame wire.SNACFrame, inBody wire.SNAC_0x02_0x05_LocateUserInfoQuery) (wire.SNACMessage, error)) *mockLocateService_UserInfoQuery_Call {
	_c.Call.Return(run)
	return _c
}
