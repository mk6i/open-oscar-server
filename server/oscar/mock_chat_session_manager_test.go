...
// RemoveUserFromAllChats provides a mock function for the type mockChatSessionManager
func (_mock *mockChatSessionManager) RemoveUserFromAllChats(user state.IdentScreenName) {
	_mock.Called(user)
	return
}
...
func (_c *mockChatSessionManager_RemoveUserFromAllChats_Call) RunAndReturn(run func(user state.IdentScreenName)) *mockChatSessionManager_RemoveUserFromAllChats_Call {
	_c.Run(run)
	return _c
}
