...
func (_mock *mockAuthService) BUCPLogin(ctx context.Context, bodyIn wire.SNAC_0x17_0x02_BUCPLoginRequest, newUserFn func(screenName state.DisplayScreenName) (state.User, error), advertisedHost string) (wire.SNACMessage, error) {
	ret := _mock.Called(ctx, bodyIn, newUserFn, advertisedHost)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, wire.SNAC_0x17_0x02_BUCPLoginRequest, func(screenName state.DisplayScreenName) (state.User, error), string) (wire.SNACMessage, error)); ok {
		return returnFunc(ctx, bodyIn, newUserFn, advertisedHost)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, wire.SNAC_0x17_0x02_BUCPLoginRequest, func(screenName state.DisplayScreenName) (state.User, error), string) wire.SNACMessage); ok {
		r0 = returnFunc(ctx, bodyIn, newUserFn, advertisedHost)
	} else {
		r0 = ret.Get(0).(wire.SNACMessage)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, wire.SNAC_0x17_0x02_BUCPLoginRequest, func(screenName state.DisplayScreenName) (state.User, error), string) error); ok {
		r1 = returnFunc(ctx, bodyIn, newUserFn, advertisedHost)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *mockAuthService_BUCPLogin_Call) Run(run func(ctx context.Context, bodyIn wire.SNAC_0x17_0x02_BUCPLoginRequest, newUserFn func(screenName state.DisplayScreenName) (state.User, error), advertisedHost string)) *mockAuthService_BUCPLogin_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockAuthService_BUCPLogin_Call) RunAndReturn(run func(ctx context.Context, bodyIn wire.SNAC_0x17_0x02_BUCPLoginRequest, newUserFn func(screenName state.DisplayScreenName) (state.User, error), advertisedHost string) (wire.SNACMessage, error)) *mockAuthService_BUCPLogin_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *mockAuthService) Signout(ctx context.Context, sess *state.SessionInstance) {
...
func (_c *mockAuthService_Signout_Call) Run(run func(ctx context.Context, sess *state.SessionInstance)) *mockAuthService_Signout_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockAuthService_Signout_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance)) *mockAuthService_Signout_Call {
	_c.Run(run)
	return _c
}

// SignoutChat provides a mock function for the type mockAuthService
func (_mock *mockAuthService) SignoutChat(ctx context.Context, sess *state.SessionInstance) {
	_mock.Called(ctx, sess)
	return
}
...
func (_c *mockAuthService_SignoutChat_Call) Run(run func(ctx context.Context, sess *state.SessionInstance)) *mockAuthService_SignoutChat_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockAuthService_SignoutChat_Call) RunAndReturn(run func(ctx context.Context, sess *state.SessionInstance)) *mockAuthService_SignoutChat_Call {
	_c.Run(run)
	return _c
}
