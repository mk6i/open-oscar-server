...
func (c *ChatRegistry) RegisterSess(chatID int, sess *state.SessionInstance) {
	c.m.Lock()
	defer c.m.Unlock()
...
func (s OSCARProxy) InitDone(ctx context.Context, sess *state.SessionInstance) string {
